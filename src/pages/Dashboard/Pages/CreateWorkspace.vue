		...
		<div class="md-layout-item md-size-100 mx-auto md-alignment-center">
			<signup-card>
				<div
					...
					style=""
				>
					<div class="mb-10" style="display: flex; justify-content: center; margin-top: 140px">
						<img class="" src="/static/icons/welcome.svg" style="width: 77.5px" />
					</div>
					<div>
						<h2 class="title text-center" style="text-align: center; width: 100%">Welcome to Maryoku!</h2>
						<h2 class="title text-center" style="text-align: center; width: 100%">
							LET’S CREATE YOUR PERSONAL WORKSPACE
						</h2>
					</div>

					<div>
						<div class="subtitle text-center" style="text-align: center; width: 100%">
							It’s easy to share all your event content via your own personal domain.

							<p style="padding-top: 0px; margin-top: 5px">
								Feel free to rename it to suit your business or workspace:
							</p>
						</div>
					</div>
					<div class="mt-5">
						<h3 class="medium_text text-center" style="text-align: center; width: 100%">Create My Domain</h3>
					</div>
				</div>
				<div slot="content-right" class="md-layout-item md-size-100 md-medium-size-100 md-small-size-100 mr-auto my-0">
					<vue-element-loading :active="loading" spinner="ring" color="#FF547C" />
					<div>&nbsp;</div>

					<div style="display: flex; align-items: center; justify-content: center">
						<div class="align-center" style="display: flex; justify-content: center; height: 30px">
							...
							>
								<div class="md-prefix mx-10" style="display: flex; justify-content: center">
					...
					<div class="mb-50 mt-70" style="display: flex; justify-content: center">
