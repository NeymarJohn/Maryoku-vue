<template>
    ...
    <div class="md-layout">
        ...
        <div class="md-layout-item">
            ...
            <signup-card style="padding-top: 32px; padding-bottom: 2px; padding-left: 0; min-width: 680px;">
                ...
                <div class="md-layout-item md-size-80" slot="content-middle">
                    ...
                    <div class="md-layout">
                        ...
                        <div class="md-layout-item">
                            <md-field :class="[{'md-valid': !errors.has('companyName') && touched.companyName},{'md-error': errors.has('companyName')}]">
                    ...
                    <div class="md-layout">
                        ...
                        <div class="md-layout-item">
                            <md-field :class="[{'md-valid': !errors.has('fullName') && touched.fullName},{'md-error': errors.has('fullName')}]">
                    ...
                    <div class="md-layout">
                        ...
                        <div class="md-layout-item">
                            <md-field :class="[{'md-valid': !errors.has('numberOfEmployees') && touched.email},{'md-error': errors.has('numberOfEmployees')}]">
                                <md-input v-model="numberOfEmployees" type="text" required data-vv-name="numberOfEmployees" v-validate="modelValidations.numberOfEmployees"></md-input>
                            </md-field>
                        </div>
                    </div>
                </div>
