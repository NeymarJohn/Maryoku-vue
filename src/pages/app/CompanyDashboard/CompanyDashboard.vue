<template>
  <div class="md-layout">
    <div class="md-layout-item md-small-size-100 md-medium-size-50 md-large-size-33">
      <company-dashboard-events-chart :number-of-events-per-year="statistics.numberOfEventsPerYear" :number-of-events-per-year-month="statistics.numberOfEventsPerYearMonth" :current-year="currentYear" :current-year-events-count="statistics.numberOfEventsPerYear[currentYear]" />
      <company-dashboard-costs-chart :event-cost-per-employee-per-year-month="statistics.eventCostPerEmployeePerYearMonth" />
    </div>
    <div class="md-layout-item md-small-size-100 md-medium-size-50 md-large-size-33">
      <company-dashboard-event-types-chart :events-per-category="statistics.eventsPerCategory" />
      <company-dashboard-satisfaction-chart :satisfaction-rates-per-year-month="statistics.satisfactionRatesPerYearMonth" />
    </div>
    <div class="md-layout-item md-small-size-100 md-medium-size-50 md-large-size-33">
      <company-dashboard-participants-chart :participants-per-event-per-year-month-event-type="statistics.participantsPerEventPerYearMonthEventType" />
    </div>
  </div>
</template>
<script>
