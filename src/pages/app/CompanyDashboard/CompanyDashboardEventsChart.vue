  ...
  >
    <template slot="chartInsideHeader">
      ...
      <h3 class="title">
        ...
        <md-switch v-model="displayByYearOrMonth" v-tooltip.bottom="'Click to view Events Distribution by Year or Month'" class="md-switch-info pull-right text-right" style="padding: 0; margin: 12px;">
      ...
      <div class="md-layout">
        <div class="md-layout-item md-size-50">
          <md-field class="">
            ...
            <md-select id="filterYear" v-model="filterYear" name="filterYear">
        ...
        <div class="md-layout-item md-size-50">
          <md-field>
            ...
            <md-select id="filterMonth" v-model="filterMonth" name="filterMonth">
              <md-option value="1">
                January
              </md-option>
              <md-option value="2">
...
export default {
  name: "CompanyDashboardEventsChart",
  components: {
    ChartCard,
    VueElementLoading
  },
