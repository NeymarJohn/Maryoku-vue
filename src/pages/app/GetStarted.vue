<template>
  <div class="md-layout get-started">
    <div class="md-layout-item md-size-100 mx-auto">
      <div
        class="md-layout"
        style="justify-content: center; top: 25%; position: absolute; width: 95%;"
      >
        <div class="md-layout-item md-xsmall-size-100 md-medium-size-30 md-size-25">
          <md-card style="min-height: 440px;">
            <md-card-content style="text-align: center;">
              <img
                src="https://static-maryoku.s3.amazonaws.com/storage/img/calendar.png"
                style="width: 120px;"
              />
              <h4 class="get-started-card-title">Create Your First Event</h4>
              <p
                class="get-started-card-description"
              >Everything you need to produce the best event that invitees would love</p>
              <p>&nbsp;</p>
        ...
        <div class="md-layout-item md-xsmall-size-100 md-medium-size-30 md-size-25">
          <md-card style="min-height: 440px;">
            <md-card-content style="text-align: center;">
              ...
              <p
                class="get-started-card-description"
              >Use a robust event calendar to manage yearly budget and events</p>
              <p>&nbsp;</p>
        ...
        <div class="md-layout-item md-xsmall-size-100 md-medium-size-30 md-size-25">
          <md-card style="min-height: 440px;">
            <md-card-content style="text-align: center;">
              <img
                src="https://static-maryoku.s3.amazonaws.com/storage/img/tools.png"
                style="width: 120px;"
              />
              <h4 class="get-started-card-title">Manage Vendors</h4>
              <p
                class="get-started-card-description"
              >Manage all vendors and proposals in one location and discover new and vetted vendors</p>
              <p>&nbsp;</p>
      ...
      this.$root.$on("get-started-event-created", (event) => {
        ...
        let calendar = new Calendar({
          ...
          annualBudgetPerEmployee: Number(
            event.numberOfParticipants * event.budgetPerPerson,
          ),
        }).save();
