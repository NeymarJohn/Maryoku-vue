<template>
  <div class="md-layout event-campaign-section booking-section">
    ...
    <div class="campaign-content md-layout-item md-size-100 mt-30">
      ...
      <save-date v-if="selectedTab == 1" :info="campaigns[1]"></save-date>
      <rsvp v-if="selectedTab == 2" :info="campaigns[2]"></rsvp>
      <countdown v-if="selectedTab == 3" :info="campaigns[3]"></countdown>
      <feedback v-if="selectedTab == 4" :info="campaigns[4]"></feedback>
  ...
  export default {
    ...
    data() {
      return {
        ...
        campaigns: {
          1: { completed: false, name: "SAVING_DATE"},
