<template>
  <div class="white-card feedback-campaign">
    ...
    <div class="p-50">
      ...
      <div class="mt-60">
        <md-button class="md-simple edit-btn md-red"><img :src="`${$iconURL}Campaign/Group 9327.svg`" class="mr-20"/>Feel free to add more questions</md-button>
      </div>
    </div>
    <hr/>
...
export default {
  ...
  created(){
    ...
    Your feedback is extremely valuable to our ongoing effort to offer great ${this.event.guestType || 'employee'} experience.
