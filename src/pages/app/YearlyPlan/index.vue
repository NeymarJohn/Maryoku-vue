<template>
  <div class="md-layout">
    ...
    <div class="md-layout-item md-size-100 text-right">
      <md-button name="yearly-plan-create-event" class="yearly-plan-create-event md-success text-success" @click="routeToNewEvent()">
        ...
        <md-card-content>
          ...
          <div class="md-layout">
            ...
            <div class="md-layout-item md-size-5">
              <md-button name="yearly-plan-refresh-filters" class="yearly-plan-refresh-filters md-info md-just-icon md-round" :disabled="!filtersChanged" @click="selectYear"><md-icon >refresh</md-icon></md-button>
            </div>
          </div>
