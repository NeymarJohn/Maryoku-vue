  ...
  <div class="my-event-item white-card">
    <div class="my-event-item-header">
      <div>
        ...
        <span class="color-gray font-size-14" style="padding: 20px">Created on {{ $dateUtil.formatScheduleDay(event.dateCreated, "MMM DD YYYY") }}</span>
        <md-button class="edit-btn md-simple md-red" @click="editDetail(event.id)">
          Edit Details
        </md-button>
      </div>
      <span>
        <span style="padding: 30px">In progresss 20%</span>
        <md-button class="font-size-60 md-simple edit-btn" style="vertical-align: middle" @click="expanded = !expanded"><md-icon class="font-size-60" style="font-size: 50px !important">keyboard_arrow_down</md-icon></md-button>
      </span>
    </div>
