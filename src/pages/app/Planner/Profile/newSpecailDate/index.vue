<template>
  <div>
    <div v-for="(item,index) in DateList " :key="item.id" class="md-layout mb16">
      ...
      <div class="md-layout-item md-size-10 add-date" style="padding-right:0px; padding-left:15px; " @click="saveItem(index)">
        <md-icon style="font-size: 19px !important; color: green; margin-top: 20px;">
          done
        </md-icon>
      </div>
      <div class="md-layout-item md-size-10 add-date" style="padding-right:0px; padding-left:15px; " @click="deleteItem(index)">
        <md-icon style="font-size: 19px !important; color: red; margin-top: 20px;">
          delete
        </md-icon>
      </div>
