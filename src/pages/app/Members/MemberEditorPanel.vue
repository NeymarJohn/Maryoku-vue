          ...
          <div class="md-layout">
            ...
            <div class="md-layout-item md-size-100" style="margin-bottom: 16px;">
              <div style="margin-top: 8px;">
                ...
                <md-field>
                  <multiselect :hide-selected="true" :close-on-select="false" v-model="permission" tag-placeholder="Add permission" placeholder="Add permissions" label="title" track-by="id" :searchable="false" :options="permissionsList" :multiple="true" :taggable="true" >
            ...
            <div class="md-layout-item md-size-100" style="margin-top: 24px;">
              <div class="pull-right">
                <md-button v-if="editMode"
                           ...
                           class="md-success"
                           @click="saveMemberDetails">Save</md-button>
                <md-button v-else
                           native-type="validated"
                           class="md-success"
                           @click="sendInvitation">Invite</md-button>
...
<script>
  ...
  export default {
    ...
    created() {
      let permissions = this.teamMember.permissions;
      let permissionObjects = [];
      permissions.forEach((p)=>{
        permissionObjects.push(_.findWhere(this.permissionsList,{id: p}));
      });
    ...
    methods: {
      ...
      validateEmails() {
        ...
        if (!this.teamMember.emailAddress || this.teamMember.emailAddress === '') return false;
      ...
      saveMemberDetails(){
        this.working = true;
        let permissions = _.map(this.permission,(v)=>{return v.id}).join(",");
        this.teamMember.permissions = permissions;
        let member = {
          ...
          if (this.validateEmails() && res) {
            if (this.editMode) {
              ...
              this.emailArray.forEach((item, index) => {
                ...
                if (member) {
                  member.permissions = _.map(this.permission,(v)=>{return v.id}).join(",");
