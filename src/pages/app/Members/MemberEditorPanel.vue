                    ...
                    <div class="md-layout">
                        ...
                        <div class="md-layout-item md-size-100" style="margin-bottom: 16px;">
                            <div style="margin-top: 8px;">
                                ...
                                <div >
                                    <md-checkbox :disabled="availablePermission.id === 'view'" v-for="availablePermission in allPermissions"  :key="availablePermission.id" v-model="permission" :value="availablePermission.id">{{availablePermission.title}}</md-checkbox>
                                </div>
                            </div>
                        </div>
    ...
    export default {
        ...
        mounted() {
            ...
            this.allPermissions.forEach((p)=>{
                let index = _.findIndex(permissions, (ip)=>{ return p.id === ip});
                if (index > -1){
                    p.checked = true;
