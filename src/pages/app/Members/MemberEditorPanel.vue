              ...
              <md-field>
                ...
                >
                  <template slot="tag" slot-scope="{option}" style="padding: 12px;">
                    <md-chip
                      style="background-color: #FF547C !important; color: #fff; font-weight: 500; font-size: 14px; text-align: left;"
                      :md-deletable="true"
...
export default {
  ...
  mounted () {
    let permissions = this.teamMember.permissions
      ? this.teamMember.permissions.split(',')
      : []
              ...
              if (member) {
                ...
                p.then(res => {
                  ...
                  this.teamMember.groups.forEach(group => {
                    let tg = new TeamMember(res.item)
                      .for(new Team(group))
                      .save()
                    ps.push(tg)
                  })
