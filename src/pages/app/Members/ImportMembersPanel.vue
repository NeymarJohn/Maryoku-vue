<template>
  <div class="md-layout-item md-size-50 import-members-modal">
    <modal v-if="importModalOpen" container-class="modal-container-wizard lg" @close="noticeModalHide">
      <template slot="body">
        <md-card>
          <md-card-header class="md-card-header-text md-card-header-warning">
            ...
            <md-button class="md-gray md-simple md-just-icon pull-right" style="margin-top: 32px; margin-right: 18px; margin-left: 12px;" @click="closeModal">
              <md-icon>close</md-icon>
            </md-button>
            <div class="md-group pull-right" style="margin-top: 38px;">
              <md-button v-if="currentStep === 3" class="md-button md-success md-sm" :disabled="working || noActions" @click="closeModal">
                Finish
              </md-button>
              <md-button v-if="currentStep === 2" class="md-button md-info md-sm" style="margin-left: 0.05rem;" :disabled="working || noActions" @click="nextStep">
                Next
              </md-button>
            </div>
          </md-card-header>
                  ...
                  <template slot="tab-pane-1">
                    <div class="md-layout">
                      <div class="md-layout-item md-size-100">
                        ...
                        <div class="divider" style="padding: 12px;" />
                            ...
                            <draggable>
                              ...
                              <div class="upload-box">
                                <div class="upload-box_btn form-group">
                                  ...
                                  <div class="col-sm-9">
                                    <input id="csv_file" type="file" name="csv_file" class="csv_file form-control" @change="(e) => sendCSVFile(e.target.files[0])">
                                  </div>
                                </div>
                              </div>
                            </draggable>
                  ...
                  <template slot="tab-pane-2">
                    <div class="md-layout">
                      <div class="md-layout-item md-size-100">
                        ...
                        <div class="divider" style="padding: 12px;" />
                        <md-table v-if="parseCSV" class="border-table" style="width: 55vmin; overflow: auto;">
                          ...
                          <md-table-row>
                            <md-table-head v-for="(column, index) in parseCSV.columns"
                                           v-if="column !== ''"
                                           :key="index"
                                           class="text-center"
                                           :class="{ active: sortKey === index }"
