  ...
  <div v-if="serviceType == 'cost'" class="proposal-service-table-item">
    <div v-if="!isEdit" class="proposal-service-item-wrapper align-start">
      ...
      <div class="action-cont editor-wrapper">
        <md-menu v-if="!isEdit" md-size="medium" :md-offset-x="240" :md-offset-y="-36" class="action-menu" @md-opened="isOpened">
    ...
    <div v-if="item.plannerOptions && item.plannerOptions.length > 0" class="planner-options">
      <img
      ...
      <div class="action-cont editor-wrapper text-right">
        ...
        >
          ...
          <md-menu-content>
            ...
            <md-menu-item class="md-purple menu-item-icon add-price-item-wrapper" @click="addPriceToIncludeItem">
...
export default {
  ...
  methods: {
    ...
    addAlternative() {
      ...
      if (this.item.plannerOptions && this.item.plannerOptions.length === 1)
    ...
    removeAlternative(index) {
      ...
      if(this.item.plannerOptions && this.item.plannerOptions.length === 1) this.item.plannerOptions = [];
...
.menu-item-icon:hover .tool-tip-icon{
