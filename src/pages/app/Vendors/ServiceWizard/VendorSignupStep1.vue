...
export default {
  ...
  methods: {
    ...
    updateVendor(event, fieldName) {
      ...
      this.$store.commit("vendorService/setField", { field: fieldName, value: event.target.value });
    },
    save() {
      let _this = this;
  ...
  filters: {},
  created() {
    this.$store.dispatch("vendorService/checkImages");
    ...
    this.$store.commit("vendorService/setVendor", vendorData);
  },
};
</script>
