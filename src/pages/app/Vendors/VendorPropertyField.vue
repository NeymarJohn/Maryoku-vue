    ...
    <div>
        <div v-if="item.type === 'string'">
            <md-field>
                ...
                <md-input v-model="vendor.vendorPropertyValues[item.id]" type="text" :required="item.mandatory"/>
            </md-field>
        </div>
        <div v-else-if="item.type === 'text'">
            <md-field>
                <label>{{item.name}}</label>
                <md-textarea v-model="vendor.vendorPropertyValues[item.id]" autogrow :required="item.mandatory"/>
            </md-field>
        </div>
        <div v-else-if="item.type === 'boolean'">
            <md-checkbox v-model="vendor.vendorPropertyValues[item.id]" :required="item.mandatory">
                {{item.name}}
            </md-checkbox>
        </div>
        <div v-else-if="item.type === 'integer'">
            <md-field>
                <label>{{item.name}}</label>
                <md-input v-model="vendor.vendorPropertyValues[item.id]" type="number" :required="item.mandatory"/>
            </md-field>
        </div>
        ...
        <div v-else-if="item.type === 'single-selection'">
            <md-field>
                <label>{{item.name}}</label>
                <md-select v-model="vendor.vendorPropertyValues[item.id]" :name="item.name" :id="item.id">
        ...
        <div v-else-if="item.type === 'multiple-selection-with-amount'">
            {{item.name}} <strong>{{item.type}}</strong>
        </div>
        <div v-else>
            <md-field>
