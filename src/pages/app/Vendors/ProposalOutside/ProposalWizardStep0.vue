...
export default {
  ...
  methods: {
    ...
    selectDate({multiple, date}){
      console.log('selectDate', multiple, date);
      if(multiple) {
        this.$store.commit("proposalForNonMaryoku/setEventProperty", {
          key: "startTime",
          value: this.getTimeFromFormat(date.dateRange.start.date, this.startTime, this.amPack.start, "YYYY-MM-DD hh:mm a"),
        });
        this.$store.commit("proposalForNonMaryoku/setEventProperty", {
          key: "endTime",
          value: this.getTimeFromFormat(date.dateRange.start.date, this.endTime, this.amPack.end, "YYYY-MM-DD hh:mm a"),
        });
      } else {
        this.$store.commit("proposalForNonMaryoku/setEventProperty", {
          key: "startTime",
          value: this.getTimeFromFormat(date.selectedDate, this.startTime, this.amPack.start, "YYYY-MM-DD hh:mm a"),
        });
        this.$store.commit("proposalForNonMaryoku/setEventProperty", {
          key: "endTime",
          value: this.getTimeFromFormat(date.selectedDate, this.endTime, this.amPack.end, "YYYY-MM-DD hh:mm a"),
        });
      }
