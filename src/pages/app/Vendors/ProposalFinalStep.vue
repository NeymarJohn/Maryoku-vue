    ...
    <div class="tab-content">
      ...
      <div v-if="selectedTab == 0">
        <div>
          ...
          how long it took you to answer, and how many times you were selected when you were one of the "three best &
          final", Maryoku's ranking system. We also look at how many recommenders you have and what their
          recommendations are. The three best bids will be presented to the planner as best & final. The planner can now
          choose one of them or ask for other alternatives. If she won't ask for another alternative instead of your
          offer, we will let you know. If she decides not to choose you, but someone else, we will let you know why.
          When the planner chooses you, we take care of all the prepayment. You will receive a down payment based on
        ...
        <div>
          ...
          changes may require a new and updated proposal from you. In this case, you will receive a link to your
          original proposal, there you will be able to update it and save a new version.
        </div>
      </div>
      <template v-if="selectedTab == 1">
        Deciding between vendors, isn't an easy job but someone has to do it... to make our decision a little easier, we
        want to know how long it took you to reply and what was the number of times you were chosen when your bid was
        one of the three finalists. we also look at the rating you got on our website, and go over all your
        Recommendation. Remember- even if your offer didn't make it to the final 3, you still have a chance, if the
        event planner asks for more offers, you might make the list this time.
      </template>
      <template v-if="selectedTab === 2">
        <div>
          ...
          <div>
            ...
            you with the other vendors who won, so you can work together and make sure everything is in sync.
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div>
            ...
            will be able to update it and save it as a new version.
          </div>
        </div>
      </template>
      <template v-if="selectedTab == 3">
        We save every offer you ever submitted, do we can learn all about your business and price range. next time we
        we'll already fill out most of the bid for you so you can take it easy . we will also compare between your offer
        and other offers in your filed of expertise, so that we can help you get the most out of yours.
      </template>
