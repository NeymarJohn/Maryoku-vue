<template>
  <div class="event-vision-wrapper proposal-add-personal-message-wrapper mt-40">
    ...
    <textarea placeholder="Write your intentions here…."></textarea>
    <div class="mt-50">
      <div>
        <span class="font-size-30 font-bold-extra">
          <img :src="`${$iconURL}Vendor+Landing+Page/art.svg`" class="page-icon" />Upload Inspirational Photos</span
        ><span>(15 photos top, under 20 KB)</span>
      </div>
      <div style="padding: 10px 10px 30px 30px">Photos that could fit in with the concept</div>
      <vue-dropzone
        id="dropzone"
