<template>
  <div class="attachment-item d-flex justify-content-between">
    <div class="d-flex align-center">
      <div class="font-size-20 mr-20" :class="{ 'font-bold': !!attachment.fileName }">
        {{ attachment.name }}
      </div>
    ...
    <div v-if="attachment.fileName" class="d-flex align-center font-bold">
      ...
      <md-button class="md-simple md-black edit-btn" @click="remove">
    ...
    <div v-else class="d-flex">
      ...
      <md-button
        ...
        @click="upload"
      >
        <md-icon class="font-size-18 font-bold">
          north
        </md-icon>
        Upload
      </md-button>
