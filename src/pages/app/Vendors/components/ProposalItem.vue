<template>
  <div class="proposal-item-wrapper">
    ...
    <div class="editable-sub-items-cont" v-if="step == 1 && !isVCollapsed">
    ...
    <div class="upload-files-wrapper" v-if="step == 1 && !isVCollapsed">
    ...
    <div class="add-attributes-cont" v-if="step == 2">
