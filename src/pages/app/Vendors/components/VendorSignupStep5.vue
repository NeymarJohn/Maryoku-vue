        ...
        <div class="card">
          ...
          <div v-if="opened" class="card-content">
            ...
            <p class="pt-20 font-size-16">
              I'm writing to let you know I recently started working with maryoku –an awesome web platform for non-professional event planners, </p>
            <p class="font-size-16">helping them plan events like pros. These days, I’m looking for people who can speak positively about my services and help me gain </p><p> credibility as a business.</p>
