<template>
  <div class="insight-modal px-30 py-20">
    <div class="d-flex align-center justify-content-between mb-20">
      <md-button class="md-simple md-icon-button" @click="prev">
        <md-icon class="font-size-30">
          chevron_left
        </md-icon>
      </md-button>
      <h2 class="font-size-30 font-bold-extra m-0">
        Winning Rate
      </h2>
      <md-button class="md-simple md-icon-button" @click="next">
        <md-icon class="font-size-30">
          chevron_right
        </md-icon>
      </md-button>
    ...
    <div class="d-flex mt-20 font-size-20 font-bold-extra">
      ...
      <div class="ml-auto d-flex align-center won font-size-14">
        <span class="mark bg-green mr-10" />
        I won (Total 40)
      </div>
      <div class="ml-40 d-flex align-center all font-size-14">
        <span class="mark bg-purple mr-10" />
        All proposals (Total 120)
      </div>
    </div>
    <div class="graph py-20">
      <chart :chart-data="data" :options="options" :width="500" :height="200" />
    </div>
    <div class="d-flex justify-content-start width-100">
      <div class="font-size-16 text-left">
        <div class="font-size-18 font-bold-extra mb-20">
          Our Best-Selling
          <br>Extras:
        </div>
        <p class="color-vendor">
          Your price
        </p>
        <p class="color-yellow-dark">
          Competitors price
        </p>
      </div>
      <div class="font-size-16 text-left ml-50">
        ...
        <p class="color-vendor mt-5">
          ${{ 1543 | withComma(Number) }}
        </p>
        <p class="color-yellow-dark">
          ${{ 1543 | withComma(Number) }}
        </p>
