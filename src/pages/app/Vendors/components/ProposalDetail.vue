...
<!--    <section v-if="vendorProposal.vendor.vendorCategory === 'venuerental' && vendorProposal.seatingData && Object.keys(vendorProposal.seatingData).length"-->
<!--        class="proposal-section policy-section">-->

<!--        <div class="proposal-section__title px-40">-->
<!--            <img :src="`${$iconURL}common/seating-purple.png`" width="40px"/> Seating Arrangement-->
<!--        </div>-->
