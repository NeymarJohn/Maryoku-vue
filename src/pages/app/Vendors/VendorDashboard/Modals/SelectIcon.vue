		...
		<template slot="header">
			<div class="md-layout">
				<div class="md-layout-item pl-0 md-size-90">
					<div style="">
						<h1 class="title">Select an icon</h1>
				...
				<div class="md-layout-item pl-0 md-size-10">
					<div>
						<md-button class="md-simple text-decoration-none cursor-pointer" style="margin-top: -20px" @click="close()">
		...
		<template slot="body">
			<div>
				<div class="md-layout">
					...
					>
						...
						<img
							...
							style="width: 27.1px; height: 31.1px; object-fit: contain"
						/>
					</div>
				</div>
				<div class="d-flex justify-content-end mt-50 mr-20">
					...
					<md-button
						class="md-vendor add-category-btn md-bold pa-20"
