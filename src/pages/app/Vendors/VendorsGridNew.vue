    ...
    <div class="md-layout-item md-medium-size-33 md-small-size-50 md-xsmall-size-100 md-large-size-25 md-size-20"
      ...
      :key="vendor.id">
        <div class="vendor-item">
            <div class="vendor-image" :style="`background : url(${vendorMainImage(vendor)}) center center no-repeat;`"></div>
            <div class="vendor-info">
                ...
                <div class="vendor-location">{{vendor.vendorAddressLine1 ? (vendor.vendorAddressLine1).substring(0,35) : ''}}</div>
                ...
                <div class="about-vendor">{{vendor.aboutUs ? (vendor.aboutUs).substring(0,180) + ' ...' : ''}}</div>
                <div class="actions">
                    <md-button class="md-rose md-outline" @click="routeToVendor(vendor.id, $event)">More Details</md-button>
                </div>
            </div>
