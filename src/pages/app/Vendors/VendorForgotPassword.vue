  ...
  <div class="md-layout justify-content-center align-center height-100vh">
    ...
    <div class="md-layout-item md-size-30">
      <div class="d-flex flex-column">
        ...
        <div v-if="!submitted" class="text-center font-size-30 font-bold color-black my-20">
          Forgot your Password?
        </div>
        <div v-else class="text-center font-size-30 font-bold color-black my-20">
          Check your email
        </div>
      </div>
      <signup-card>
        <div slot="content-right" class="md-layout-item md-size-100 md-medium-size-100 md-small-size-100 signin-contain">
