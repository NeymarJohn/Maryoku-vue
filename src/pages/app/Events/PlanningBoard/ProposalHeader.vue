<template>
  <section class="proposal-header selected">
    <div class="cost">
...
box-shadow: 5px -4px 5px -1px rgba(0, 0, 0, 0.08);
-webkit-box-shadow: 5px -4px 5px -1px rgba(0, 0, 0, 0.08);
-moz-box-shadow: 5px -4px 5px -1px rgba(0, 0, 0, 0.08);
