  ...
  export default {
    ...
    computed: {
      ...
      getTotalRemainingBudget() {
        return this.event.numberOfParticipants * this.event.budgetPerPerson - this.getToBePaidAmount
      },
      getRemainingBudgetPerEmployee() {
        if (this.event.budgetPerPerson == 0) {
          return 0
        } else {
          return (this.event.numberOfParticipants * this.event.budgetPerPerson - this.getToBePaidAmount) / this.event.numberOfParticipants
        }
      },
      getPercentage() {
        if (this.event.budgetPerPerson == 0) {
          ...
          return (this.getTotalRemainingBudget / (this.event.numberOfParticipants * this.event.budgetPerPerson)) * 100
        }
      },
      getSeriesData() {
