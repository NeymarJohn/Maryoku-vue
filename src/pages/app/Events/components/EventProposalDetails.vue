    ...
    <template v-if="vendorProposal.vendor">
      ...
      <div class="proposal-page_header d-flex justify-content-start">
        <div class="vendor-title">
          ...
          <a href="javascript:void(0)">{{vendorProposal.vendor.vendorDisplayName}}</a> Proposal
        </div>
      </div>
      <div class="proposal-content">
        <div class="proposal-info">
          <div
            ...
            style="background : url('https://bit.ly/392ygCu') center center no-repeat;"
          >
            ...
            <ul class="contact-list_items d-flex justify-content-start">
              ...
              <li class="contact-list_item" v-if="vendorProposal.vendor.vendorAddressLine1">
                <a href>
                  ...
                  {{vendorProposal.vendor.vendorAddressLine1}} {{vendorProposal.vendor.vendorAddressLine2}}
                </a>
              </li>
          ...
          <div class="pricing-section__list">
            <div class="pricing-section__item element-block">
              ...
              <div class="expanded-section" v-if="expand">
                <div
                  class="loading"
                  v-if="vendorProposal.proposals[0].attachements.length && !fetchingAllAttachments"
                >Loading ...</div>
                ...
                <div class="proposal-includes">
                  ...
                  <template v-if="dummyIncluded.length">
                    ...
                    >
                      ...
                      <div class="item-description" v-if="item.expanded">{{item.description}}</div>
                    </div>
                  </template>
                </div>
        ...
        <div class="proposal-section policy-section">
          ...
          <div class="policy-content">
            ...
            <div class="additional-info">
              ...
              >{{vendorProposal.proposals[0].candellationPolicy}}</div>
            </div>

            <div class="signature-section">
              <div class="signature-section__vendor">{{vendorProposal.vendor.vendorDisplayName}}</div>
      ...
      <div class="book-proposal-form">
        ...
        <div class="agree-checkbox">
          ...
          >Please indicate that you accept the new time of this proposal</div>
        </div>
