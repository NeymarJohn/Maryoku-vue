...
<!--                        </tr>-->
            ...
            <div class="book-proposal-form">
                <div class="form-title">
                    Would you like to book <a href="">Relish caterers & venues</a>?
                </div>
                ...
                <div class="form-actions text-right">
                    <md-button class="md-rose md-simple"> <md-icon>keyboard_arrow_left</md-icon> Back to other proposals</md-button>
