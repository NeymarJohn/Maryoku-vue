  ...
  <div class="comment-item" :class="{child: !isMain}">
    <div class="d-flex justify-content-between">
      <div class="comment-item-avatar" v-if="proposal">
        <Avartar :name="comment.planner.name" :color="proposal.avatar_color" v-if="comment.planner && comment.planner.name"></Avartar>
        <Avartar :name="comment.customer.name" :color="proposal.avatar_color" v-if="comment.customer && comment.customer.name"></Avartar>
