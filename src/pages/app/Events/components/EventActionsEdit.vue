<template>
  <div class="event-status-field">
    <div class="flex-end">
      ...
      <md-button native-type="submit" class="md-success" style="display: none;" @click="openImageGallery">
        Image Gallery
        <span v-if="uploadedImages.length" class="badge md-round md-info">{{ uploadedImages.length }}</span>
      </md-button>

      <md-button native-type="submit" class="md-success" @click="submitForm">
        Save
      </md-button>
    </div>
