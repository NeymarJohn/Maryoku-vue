      ...
      <div class="md-layout-item md-size-100">
        <div v-for="(category, index) in Object.keys(requirementProperties)" :key="index">
          ...
          <div class="requirement-section" v-else-if="category=='special'">
            <div class="d-flex align-start" >
              ...
              <div>
                <div 
                  ...
                  v-for="(property, index) in requirementProperties[category].filter(item=>!item.isSelected)" :key="index"
            ...
            <div class="md-layout mt-50" v-for="(property, index) in requirementProperties[category].filter(item=>item.isSelected)" :key="index">
              ...
              <div class="md-layout-item md-size-20 mx-auto">
                ...
                <div>
                  ...
                  <md-checkbox class="md-simple md-checkbox-circle md-red" v-model="property.mustHave" :value="false">
                ...
                <tr 
                  ...
                  <td>
                    <md-button class="md-icon-button md-simple requirement-action" v-if="property.qtyEnabled">
                      <img :src="`${$iconURL}Requirements/edit-dark.svg`" width="20"/></md-button>
                    <md-button class="md-icon-button md-simple requirement-action" @click="removeRequirement(category, property)">
