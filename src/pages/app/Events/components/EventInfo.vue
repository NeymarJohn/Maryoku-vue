            ...
            <template slot="footer">
              <div class="md-layout">
                <div class="md-layout-item">
                  <i class="fa fa-circle text-success" /> Remaining Budget (${{ event.totalBudget - spentBudget }})
                </div>
                <div class="md-layout-item">
                  <i class="fa fa-circle text-danger" /> Spent Budget (${{ spentBudget }})
                </div>
                <div v-if="spentBudget > event.totalBudget" class="md-layout-item md-size-100">
                  <div class="warning text-warning">
                    Budget is exceeded. You should either increase total budget or update costs
                  </div>
                </div>
