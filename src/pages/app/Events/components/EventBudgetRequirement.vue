<template>
  ...
  <div v-else class="md-layout event-budget-section booking-section">
        ...
        <div class="header-name" style="width: max-content">
          ...
          <template v-else>
            ...
            <div class="text-transform-capitalize">
              An itemized budget, generated by our smart technology and based on thousands of real event quotes
            </div>
          </template>
        </div>
    ...
    <div v-if="currentStep === 3" class="booking-header md-layout-item md-size-100">
      <event-budget-approve />
    </div>
    <div v-else class="booking-header md-layout-item md-size-100">
      <event-budget-requirement-step1
        v-if="currentStep === 1"
        :default-data="budgetInfo1"
        @change="setEventStep1"
      />
      <event-budget-requirement-step2
        v-if="currentStep === 2"
        :default-data="budgetInfo2"
