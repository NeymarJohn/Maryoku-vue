            ...
            <div class="concepts-list md-layout-item md-size-100">
                ...
                >
                    ...
                    <div class="concept-details" v-if="!expandCreateConcept">
                        <h3 class="create-name">Create Your Own Concept</h3>
                        ...
                        <div class="form-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="colors-list d-flex justify-content-start">
                                    <div v-for="(color, index) in newConcept.colors" :key="index" style="margin-right: 30px">
                                        <color-button v-model="color.value"></color-button>
                            ...
                            <div class="images-list new-concept">
                                <div class="image-backgrounds">
                                    ...
                                    <div class="image-background" v-for="idx in 4" :key="idx" :style="`background-color: ${newConcept.colors[idx-1].value}`">
                                    </div>
                                </div>
                                <div>
                                    <div :class="`images-list__item`"
        ...
        <div class="concept-content" v-else>
            ...
            <div class="concepts-list md-layout-item md-size-100">
                <div class="concepts-list__item d-flex justify-content-start"
                    :class="{expanded : true}"
                >
                    <div :class="`images-list option-1`">
                        <div class="image-backgrounds">
                    ...
                    <div class="concept-details">
                        <small>Option 0{{selectedConcept.option}}</small>
                        <div class="concept-name">
      ...
      _calendar.calendarEvents().find(this.$route.params.id).then(event => {
        ...
        if (event.concept) {
            ...
            this.selectedConcept.images.forEach((item, i)=>{
                item.url = "http://static.maryoku.com/" + item.url
            }) 
            this.showConceptList = false
        } else {
