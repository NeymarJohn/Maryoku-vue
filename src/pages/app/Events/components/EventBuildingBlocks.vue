              ...
              >
                ...
                <td class="fit-content text-center">
                  <template>
                    ...
                    <template
                      v-else-if="(block.proposalsState==='show-proposals' || block.proposalsState==='waiting-for-proposals')"
                    >
                      <md-button
                        class="md-sm md-danger btn-proposal"
                        @click="reviewProposals(block)"
                      >
                        Manage proposals
                    ...
                    <template v-else-if="block.proposalsState==='get-offers'">
                      <md-button
                        class="md-sm md-primary btn-view-order"
                        @click="reviewProposals(block)"
                      >
                        Get Proposals
      ...
      if (val) {
        if (val.toString().toLowerCase() === 'click to set') {
          ...
          if (block.allocatedBudget && block.numberOfParticipants) {
            ...
            block.allocatedBudget = !this.event.elementsBudgetPerGuest
              ? val
              : val * block.numberOfParticipants
          } else {
            selected_block.allocatedBudget = !this.event.elementsBudgetPerGuest
