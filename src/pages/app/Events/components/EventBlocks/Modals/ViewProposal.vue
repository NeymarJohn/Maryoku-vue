          ...
          <md-card class="proposal-message">
            <md-card-content>
              <div class="vendor-info">
                ...
                <div
                  class="last-update"
                >Last Update on {{getDate(vendorInfo.lastUpdated)}} (3 updates)</div>
              </div>
            ...
            <md-card-content>
              <div class="cost-info">
                <div class="cost-info_desc">
                  ...
                  <div
                    class="down-payment"
                  >Down Payment : ${{vendorProposal.cost *.1 | numeral(0,0)}}</div>
                </div>
                <div class="cost-info_desc">
              ...
              <div class="proposal-pros-cons">
                <div class="section-content pros-section">
                  ...
                  <ul class="list-items">
                    ...
                    <li
                      v-for="(item,index) in vendorProposal.pros"
                      :key="index"
                    >{{getStringWithRoundedNumber(item)}}</li>
                  </ul>
                </div>
        ...
        <div class="md-layout-item md-size-95 cost-breakdown-notes md-hide">
          ...
          <div class="cost-breakdown-notes-sections">
            ...
            <div class="section-content notes-section">
              ...
              <p
                class="danger-label"
              >This offer is valid till {{getDate(vendorProposal.validUntil)}}.</p>
            </div>
          </div>
        </div>
          ...
          <ul class="feedback-list-items">
            <li class="feedback-item">
              ...
              <div class="item-info">
                ...
                <div class="item-body">
                  <p>A 50% deposit will be due on or before 18/1/20. The remaining balance will be collected a week prior to the event. We accept all major credit cards and checks.</p>
                  <p>The estimated amount above is not a fixed amount and is subject to change based on actual charges and final guest counts and any additional charges approved by the Client.</p>
                </div>
            ...
            <li class="md-hide">
              <div class="proposal-info">
                <div class="proposal-title">
                  Payment & cost
                  <span>
                    <md-icon>attach_money</md-icon>Net +30
                  </span>
                </div>
            ...
            <li>
              ...
              <div class="attachments-list md-hide">
                <ul class="attachments-list_items">
                  <li>
                    <a href>
                      <md-icon>attach_file</md-icon>Insurance certificate
                    </a>
                  </li>
                  <li>
                    <a href>
                      <md-icon>attach_file</md-icon>Other business indication
                    </a>
                  </li>
                </ul>
              </div>
