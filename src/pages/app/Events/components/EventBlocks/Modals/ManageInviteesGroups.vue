    ...
    <div class="md-layout" style="max-height: 100vh;">
      <div class="md-layout">
          ...
          <md-card>
            <md-card-header class="md-card-header-text">
              ...
              <div class="card-actions pull-right">
                ...
                <md-button
                  class="md-info md-sm event-planner-tab-invitees-management-create-group"
                  @click="addMember"
            ...
            <md-card-content class="groups-list">
              ...
              >
                ...
                <div class="card-actions pull-right">
                  ...
                  <md-button
                    class="md-success md-sm md-just-icon md-simple"
                    @click="ManageInvitees(group)"
                  >
        ...
        <div class="md-layout-item md-size-50" v-if="groupInvitees.length">
          <h5>
            Add members to '
            <span>{{selectedGroup.title}}</span>' group manually
            <br />or
      ...
      swal({
        ...
        if (result.value) {
          ...
          this.members.forEach(member => {
            let invitee = new EventInvitee({ id: member.id }).for(
              this.selectedGroup
            )
