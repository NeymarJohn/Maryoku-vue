    ...
    <div class="manage-groups-panel">
        <div class="md-layout" style="max-height: 100vh;">
            <div class="md-layout-item md-size-100 preview-section">
                ...
                <h4 class="section-title"><b>Edit {{selectedInteraction.title}} Design</b></h4>
    ...
    export default {
        ...
        mounted() {
          if (!this.selectedInteraction.templateImage){
            alert(JSON.stringify(this.selectedInteraction.options[0]));
            this.selectTemplateImage(this.selectedInteraction.options[0]);
          }
        },
        methods: {
            cancel(){
            ...
            editInteractionDesign(){
                ...
                let interaction = new EventInteraction({id: this.selectedInteraction.hashed_id});
