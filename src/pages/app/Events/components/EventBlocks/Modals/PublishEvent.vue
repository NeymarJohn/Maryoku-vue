                        ...
                        <div class="md-layout-item md-size-100  clear-margins">
                            <div class="md-layout">
                                <div class="md-layout-item md-size-85">
                                    <md-field v-if="event">
                                        <md-input v-model="publishUrl" :value="publishUrl"  id="event-link" v-focus  ref="publishUrlInput"></md-input>
                                    </md-field>
                                </div>
                                <div class="md-layout-item md-size-10 text-left" style="white-space: nowrap;">
                                    <md-button style="top: 30%" :disabled="copyDone" class=" md-success md-xs md-just-icon" @click="copyLink">
                                        <md-icon v-if="!copyDone">assignment</md-icon>
                                        <md-icon v-if="copyDone">check</md-icon>
                                        <md-tooltip>Copy to clipboard</md-tooltip>
                                    </md-button>
                                    <md-button style="top: 30%" :disabled="copyDone" class=" md-info md-xs md-just-icon" @click="openInNewTab">
