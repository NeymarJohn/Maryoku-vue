        ...
        <md-card v-if="interactionsList">
          ...
          <md-card-content class="md-layout">
            <div class="md-layout-item md-size-100">
              ...
              <!-- Interactions List -->
              <div v-if="interactionsList.length" class="interactions-list">
                <div
                  ...
                  <div class="md-layout">
                    <div class="md-layout-item">
                      <h4 class="interaction-title">
                        <md-checkbox v-model="item.enabled" @change="checkItem(item)" />
                        {{ item.title }}
                      </h4>
                    </div>
                  </div>
                  ...
                  >
                    <div class="md-layout-item md-size-100">
                      <div class="send-date-field md-layout">
                        ...
                        <md-datepicker v-model="item.sendOnDate" class="md-layout-item md-size-75">
                          <label />
                        </md-datepicker>
                      </div>
                    </div>
                    <div class="md-layout-item md-size-100">
                      <div class="send-date-field md-layout">
                        ...
                        <md-field class="md-layout-item md-size-35">
                          <md-input v-model="item.sendDaysBeforeEvent" type="number" />
                        </md-field>
                      </div>
                    </div>
                    <div class="md-layout-item md-size-100">
                      <div class="send-date-field">
                        <md-checkbox :id="`include-${index}`" v-model="item.include_link" />
                        <label
                    ...
                    <div class="md-layout-item md-size-100">
                      <div class="text-right">
                        <md-button class="md-success md-sm" @click="editInteraction(item)">
                          Save
                        </md-button>
                        <md-button
                          class="md-rose md-sm"
