                    ...
                    <md-card-content>
                        ...
                        <md-autocomplete
                            ...
                            <template slot="md-autocomplete-empty" slot-scope="{ term }">
                                No groups match your search, you can create a new group.
                            </template>
                        ...
                        <div>
                            <md-chip v-for="option in selectedEventGroups" :key="option.id" :md-deletable="true"
                                     :md-clickable="true" class="md-rose"
                                     @md-delete="eventGroupUnselected($event, option)">{{option.title}}
                            </md-chip>
                        </div>
                    ...
                    <md-card-content class="md-layout">
                        <div class="md-layout-item md-size-100">
                            ...
                            <div class="interactions-list" v-if="interactionsList.length">
                                <div class="interactions-list_item" v-for="(item,index) in interactionsList"
                                     :key="index" @click="selectInteraction(item)"
                                     :class="{selected_interaction : selectedInteraction && item.id == selectedInteraction.id}">
                                    <div class="md-layout">
                                        <div class="md-layout-item">

                                            <h4 class="interaction-title">
                                                <md-checkbox v-model="item.enabled"
                                                             @change="checkItem(item)"></md-checkbox>
                                                {{item.title}}
                                            </h4>
                                        </div>
                                    </div>
                                    <div class="md-layout"
                                        ...
                                        <div class="md-layout-item md-size-100">
                                            <div class="send-date-field md-layout">
                                                <label class="md-form-label md-layout-item md-size-25">
                                                    Send Date
                                                </label>
                                        ...
                                        <div class="md-layout-item md-size-100">
                                            <div class="send-date-field md-layout">
                                                <label class="md-form-label md-layout-item md-size-65">
                                                    Days to send before the event
                                                </label>
                                                <md-field class="md-layout-item md-size-35">
                                                    <md-input type="number"
                                                              v-model="item.sendDaysBeforeEvent"></md-input>
                                                </md-field>
                                            </div>
                                        </div>
                                        <div class="md-layout-item md-size-100">
                                            ...
                                            <div style="margin-bottom : 1em;">Still don't have one? <a
                                                    href="javascript:void(0)" @click="goToComponent('')">click here</a>
                                        ...
                                        <div class="md-layout-item md-size-100">
                                            <div class="text-right">
                                                ...
                                                <md-button class="md-rose md-sm" @click="editInteractionDesign(item)">Edit Design</md-button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods: {
            eventGroupSelected(group) {
                this.possibleEventGroupsList.splice(_.findIndex(this.possibleEventGroupsList, (g) => {
            ...
            eventGroupUnselected($event, group) {
                this.selectedEventGroups.splice(_.findIndex(this.possibleEventGroupsList, (g) => {
                    return g.id === group.id
                }), 1);
