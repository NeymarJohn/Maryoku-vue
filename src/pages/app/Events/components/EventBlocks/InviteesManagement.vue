<template>
  <div class="invitees-management">
    ...
    <div class="md-layout">
      <div class="md-layout-item md-size-30">
        <md-card >
          <md-card-header class="md-card-header-icon md-card-header-warning">
            ...
            <h4 class="title2">Select invitee groups</h4>
          </md-card-header>
          <md-card-content>
            ...
            <md-autocomplete
                            ...
                            :md-open-on-focus="false" aria-autocomplete="none">
            ...
            <div>
              <md-chip v-for="option in selectedEventGroups" :key="option.id" :md-deletable="true" :md-clickable="true" class="md-rose" @md-delete="eventGroupUnselected($event, option)">{{option.title}}</md-chip>
            </div>
      ...
      <div class="md-layout-item md-large-size-70" v-if="interactionsList">
        <md-card>
...
<script>
  ...
  import ManageInviteesGroups from './Modals/ManageInviteesGroups';

  export default {
    name: 'invitees-management',
    components: {
      ManageInviteesGroups,
      VueElementLoading,
    },
    props: {
      event
    ...
    methods: {
      eventGroupSelected(group){
        this.possibleEventGroupsList.splice(_.findIndex(this.possibleEventGroupsList, (g)=>{ return g.id === group.id}),1);
        this.selectedEventGroups.push(group);
      },
      eventGroupUnselected($event, group){
        this.selectedEventGroups.splice(_.findIndex(this.possibleEventGroupsList, (g)=>{ return g.id === group.id}),1);
