        ...
        <md-card-content>
          ...
          <div class="md-layout" style="margin: 0;">
            ...
            <div class="md-layout-item text-center md-size-50">
              <iframe id="kfrm" style="border: 1px solid lightgrey; border-radius: 5px; width: 20vmax; height: 20vmax; margin-left: auto; margin-right: auto;" ></iframe>
            </div>
            <div class="md-layout-item md-size-50">
              <md-field>
                <label>Title</label>
                <md-input v-model="interactionData.line1"
                          data-vv-name="line1"
                          v-focus
              ...
              <md-field>
                <label>Date</label>
                <md-input v-model="interactionData.line2"
                          data-vv-name="line2"
                          @keyup.native="updatePreview(interactionData)"/>
              </md-field>
              <md-field>
