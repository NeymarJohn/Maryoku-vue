                ...
                <li v-for="item in timelineItems" :key="item.id" class="time-line-blocks_selected-items_item time-line-item">
                    ...
                    <md-card class="block-info" >
                        ...
                        <div class="card-actions" style="width: 100%;">
                            <span class="item-time" style="display: inline-block; margin: 14px; padding: 2px 12px !important; font-size: 1.6vmin;" :style="`background : ` + item.color">{{ item.startTime }} - {{item.endTime}}</span>
                        </div>
