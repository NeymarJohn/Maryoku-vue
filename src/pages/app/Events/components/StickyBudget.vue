<template>
  <div v-if="event" class="sticky-budget">
    <div class="md-layout">
        ...
        <div class="section-content">
          ...
          <div v-if="expanded">
            ...
            <div class="md-layout md-gutter">
              ...
              <div class="md-layout-item md-large-size-50 md-caption title-text">
                {{ event.numberOfParticipants }} + Spouses
              </div>
            </div>
            <div class="md-layout md-gutter">
              <div class="md-layout-item md-large-size-50 md-caption title-text">
            ...
            <div class="md-layout md-gutter">
              ...
              <div class="md-layout-item md-large-size-50 md-caption title-text">
                {{ event.eventStartMillis | formatTime }} {{ event.eventStartMillis | formatDuration(event.eventEndMillis) }} Hours
              </div>
            </div>
          </div>
        </div>
      </div>
      <div v-if="buildingBlocksList.length && expanded" class="md-layout-item md-large-size-30  md-xlarge-size-30">
        <div class="building-blocks-list md-info">
          <div class="md-layout md-gutter gutter-header">
            <div class="md-layout-item md-caption title-text">
              Items
            </div>
            <div class="md-layout-item md-caption title-text">
              budget
          ...
          <div v-for="(block,index) in buildingBlocksList" :key="index" class="md-layout md-gutter">
            <div class="md-layout-item md-caption title-text">
              {{ block.value }}
            </div>
            <div class="md-layout-item  md-caption title-text">
      ...
      <div v-if="expanded" class="md-layout-item md-size-40 budgets-charts">
        <div class="budgets-charts_list">
          <div class="md-layout md-gutter">
            <div class="md-layout-item md-size-80  title-text">
              Total budget for the event
            </div>
            <div class="md-layout-item  md-size-20 md-caption ">
              ${{ calendarEvent.totalBudget }}
            </div>
          </div>
          ...
          <div class="md-layout md-gutter">
            ...
            <div class="md-layout-item  md-size-20 md-caption t">
              $0
            </div>
          </div>
          <div class="md-layout md-gutter">
        ...
        <div style="display: grid;">
          ...
          />
          <animated-number ref="percentageNumber" class="percentage" style="text-align: center;" :value="percentage" suffix="%" />
        </div>
      </div>

      <div v-if="!expanded" class="md-layout-item md-large-size-45 md-xlarge-size-55">
        <u class="event-info">
      ...
      <div v-if="!expanded" class="md-layout-item md-large-size-35  md-xlarge-size-25">
        <ul class="event-info budget-info">
          <li class="event-info_item">
            <div class="budget-title">
              Per participant
            </div>
            <div class="budget-value pull-right">
              $15
            </div>
          </li>
          <li class="event-info_item">
