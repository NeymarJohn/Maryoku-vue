<template>
  <div class="md-layout">
    <modal v-if="modalOpen" :allow-click-outside="false" @close="noticeModalHide">
        ...
        <form>
            ...
            <div class="md-layout-item">
              ...
              >
                ...
                <template slot="md-autocomplete-item" slot-scope="{ item, term }">
                  ...
                  <div class="text-gray pull-right small" style="text-transform: uppercase;">
                    {{ item.group }}
                  </div>
                </template>
              </md-autocomplete>
          ...
          <div class="md-layout">
            <div class="md-layout-item">
              ...
              >
                <label>Value</label>
                <span v-if="errors.has('value')" class="md-error">This field is required</span>
              </md-autocomplete>
            </div>
          </div>
          ...
          <div class="md-layout">
            <div class="md-layout-item">
              <md-field :class="[{'md-error': errors.has('comment')}]" class="mb16">
                <label>Comment</label>
                <md-textarea v-model="form.comment"
                             md-autogrow
                             data-vv-name="comment"
                             style="min-height: 36px;"
                />
                <span v-if="errors.has('comment')" class="md-error">This field is required</span>
              </md-field>
            </div>
          </div>
        </form>
