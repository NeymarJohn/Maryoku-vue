<template>
    <div class="md-layout brief-details">
        <div class="md-layout-item md-size-100">
            <tabs
                :tab-name="['Venue (3)', 'Catering (6)', 'Rentals (2)']"
                color-button="primary" class="vertical-tabs md-vertical">
                    ...
                    <div class="md-layout">
                        ...
                        <div class="md-layout-item md-size-100">
                            <div class="section-header">
                                ...
                                <md-button class="md-primary md-sm md-simple"> <md-icon>refresh</md-icon> load requirements from history </md-button>
                            </div>
                        </div>
                                ...
                                <div class="list-container">
                                    <div v-for="category in categories" :key="category.id"
                                        ...
                                        <div class="list-item--actions">
                                            <md-button class="md-just-icon md-primary md-sm md-simple action-btn"><md-icon>add_circle</md-icon></md-button>
                                        </div>
