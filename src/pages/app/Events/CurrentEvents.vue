<template>
  <div class="md-layout edit-event-details">
    ...
    <div class="event-details-tabs">
      <tabs
        ref="eventPlannerTabs"
        :tab-name="['BUDGET & PROPOSALS','TIMELINE', 'INVITEES']"
        color-button="rose" :active-tab="$store.state.EventPlannerVuex.eventDetailsActiveTab" :sync-router="true"
      >
        here you can add your content for tab-content
        <template slot="tab-pane-10" style="width: 100%;">
          <div class="md-layout">
            <div class="md-layout-item md-size-25">
              <event-details-sidebar :event.sync="event" :event-statistics.sync="event.statistics" />
            </div>
          ...
          <div class="md-layout">
            ...
            <div class="md-layout-item md-size-75">
              <event-building-blocks :event.sync="event" :event-components="selectedComponents"
                                     @go-to-building-blocks="resetTab"
              />
            </div>
          </div>
        </template>
        <template slot="tab-pane-2" style="width: 100%;">
          <div class="md-layout">
            <div class="md-layout-item md-size-100">
              <event-time-line :event="event" :event-components="selectedComponents" />
            </div>
          </div>
        </template>
        <template slot="tab-pane-3" style="width: 100%;">
          <div class="md-layout">
            <div class="md-layout-item md-size-100">
              <event-invitees :event-data.sync="event" />
            </div>
          </div>
        </template>
