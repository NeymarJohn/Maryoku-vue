<template>
    <div class="md-layout md-alignment-top-center" >
        <div class="md-layout-item md-size-70 margin-bottom-lg">
            <h3 class="title">
              <md-icon class="md-success md-size-2x">check_circle</md-icon> You've been added to our marketplace as
              <a href="#">vetted vendor</a>.
            </h3>
        </div>
        <div class="md-layout-item md-size-70 margin-bottom-md">
          <h4 class="title">
            What's 262 days?
          </h4>
              ...
              <div class="md-layout">
                <div class="md-layout-item separated">
                  ...
                  <div class="md-layout align-with-title">
                    ...
                    <div v-if="proposalRequest.bidderRank > 1" class="md-layout-item md-size-50 margin-bottom-md">
                      <div>Budget</div>
                ...
                <div class="md-layout-item">
                  <div class="proposal--title margin-bottom-lg centered">
                    <span v-if="proposalRequest.bidderRank > 1">
                  ...
                  <div class="md-layout md-alignment-top-center margin-bottom-lg">
                    <div v-if="proposalRequest.bidderRank > 1" class="md-layout-item margin-bottom-md md-size-20">
                      <div>Lowest</div>
                      <p class="proposal--title">
