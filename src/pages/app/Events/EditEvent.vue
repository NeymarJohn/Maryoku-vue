<template>
  <div class="md-layout">
    ...
    <div class="md-layout-item md-size-100">
      <event-actions-edit :form-data="formData" :should-update="true" :event="event" />
    </div>
    ...
    >
      <event-header-form
        :occasion-options="occasionsArray"
        :form-data="formData"
        :should-update="true"
        :event="event"
      />
    ...
    >
      <pricing-card card-class="md-card-plain" icon-color="icon-black">
          ...
          <ul class="dropdown-menu" :class="{'dropdown-menu-right': responsive}">
            ...
            >
              <a :class="item.childComponents ? 'dropdown-toggle' : ''">
                {{ item.value }}
                <ul v-if="item.childComponents" class="dropdown-menu">
                  <li
        ...
        <h3 slot="title" class="title black-color">
          Space, Catering, Decorations and more ...
        </h3>
        <p
          slot="description"
          class="card-description"
        >
          Plan and manage here all the ingredients for a successful event.
        </p>
      </pricing-card>
    </div>
    <div
    ...
    >
      <time-line plain :type="'simple'" class="mt-0">
        <event-card-component
          ...
          :delete-component-item="deleteComponentItem"
        ...
        >
          <div slot="content">
            <drop-down ref="dropdown" direction="down" class="dropdown-component-button">
              <md-button slot="title" class="md-info md-block" data-toggle="dropdown">
