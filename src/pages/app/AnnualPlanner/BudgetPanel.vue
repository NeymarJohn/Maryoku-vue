        ...
        <form class="budget-form">
          <div>
            <div style="text-align: center;">
              ...
              <div class="d-flex items-center-g">
                ...
                <md-button class="md-simple md-just-icon md-round fa fa-edit" @click="toogleEditAnnualBudgetPerEmployee">
          ...
          <div>
            <div style="text-align: center;">
              ...
              <div class="d-flex items-center-g">
                ...
                <md-button class="md-simple md-just-icon md-round fa fa-edit" @click="toogleEditTotalAnnualBudget">
                  <md-icon>edit</md-icon>
                </md-button>
              </div>
            </div>
  ...
  export default {
    ...
    methods: {
      calendarStatistic() {
        ...
        // calendar = Calendar.statistics().get().then(statistics => {
