            ...
            <modal v-if="eventModalOpen">
                <template slot="header">
                    <div class="md-layout d-flex items-center-g">
                            <div class="md-layout-item md-size-50 md-small-size-100 d-flex items-center-v text-center">
                                <md-field v-if="this.editTitle" :class="[{'md-error': errors.has('eventName')}]">
                                ...
                                <h4 class="modal-title" v-else>
                                  ...
                                  <span v-else-if="modalTitle && !eventName">{{modalTitle}}</span>
                                </h4>
  ...
  export default {
    ...
    methods: {
      ...
      validateTitle() {
        if (!this.eventName) {
           this.editTitle = true;
           this.errors.add({ field: 'eventName', msg: '1'})
        }
      },
      updateEvent() {
