              ...
              <div class="md-layout-item md-size-95 md-small-size-100">
                <md-field :class="[
                  ...
                  <md-select
                    ...
                    <md-option v-for="role in availableRoles" :key="role.id" :value="role.id">{{role.title}}</md-option>
                  </md-select>
                  <slide-y-down-transition>
              ...
              <div class="md-layout-item md-size-95 md-small-size-100">
                <md-field :class="[
                  ...
                  <md-select
                    ...
                    name="select"
                    multiple>
                    <md-option v-for="permission in availablePermissions" :key="permission.id" :value="permission.id">{{permission.title}}</md-option>
                  </md-select>
                  <slide-y-down-transition>
