    ...
    <div class="md-layout-item md-size-100">
      ...
      <md-card class="" v-else>
        <md-card-content style="min-height: 60px;">
          ...
          <team-table :current-user-id="auth.user.id" :available-permissions="permissions" :available-roles="roles" :team-id="team.id" :teamMembers="teamMembers" @membersRefresh="fetchData(pagination.from)"></team-table>
