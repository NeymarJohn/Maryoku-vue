  ...
  <div class="">
    <div class="section-header">
      <h2 class="section-title">
        Tell us about the people you invited?
      </h2>
    ...
    <div class="container">
      <div class="form-section">
        <md-field class="purple-field">
          ...
          <md-input v-model="eventData.numberOfParticipants"
                    v-validate="modelValidations.numberOfParticipants"
                    type="number"
                    data-vv-name="numberOfParticipants"
          />
          <span v-if="errors.has('numberOfParticipants')" class="md-error">This field is required</span>
        </md-field>
        ...
        <div class="maryoku-field" :class="{'has-value' : eventData.expectedAttendacePercent}">
          <v-select v-model="eventData.expectedAttendacePercent"
                    v-validate="modelValidations.expectedAttendacePercent"
          ...
          <span v-if="errors.has('expectedAttendacePercent')" class="md-error">This field is required</span>
        </div>
        ...
        <div class="form-actions">
          <md-button class="md-rose next-btn custom-btn"
                     :class="[{'disabled': !eventData.numberOfParticipants || !eventData.expectedAttendacePercent}]"
                     @click="goToNext"
          >
            Next
          </md-button>
    ...
    <go-back navigation="create-event-wizard" />
  </div>
</template>
