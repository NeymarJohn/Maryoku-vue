    ...
    <div class="">
        ...
        <div class="container">
            <div class="form-section">
                ...
                <div class="field-small-note"> <small>Guest estimation: {{ publicEventData.numberOfParticipants * (publicEventData.expectingPeople.value / 100) | numeral('0,0')}}</small> </div>
