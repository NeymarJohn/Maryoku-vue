  ...
  <div class="">
    <div class="section-header">
      <h2 class="section-title">
        And the million dollar question - your budget
      </h2>
    ...
    <div class="container">
      <div class="form-section">
        <md-field class="purple-field">
          ...
          />
          <span v-if="errors.has('totalBudget')" class="md-error">This field is required</span>
        </md-field>
        ...
        <md-field class="purple-field">
          ...
          />
          <span v-if="errors.has('budgetPerPerson')" class="md-error">This field is required</span>
        </md-field>
        <div v-if="publicEventData.expectedAttendacePercent" class="field-small-note">
          <small>Guest estimation: {{ Math.round(publicEventData.numberOfParticipants * (publicEventData.expectedAttendacePercent.value / 100)) }}</small>
        </div>
        ...
        <div class="form-actions two-btns">
          <md-button class="md-default next-btn custom-btn"
                     ...
                     @click="skip"
                     @mouseover="buttonLabel='I don\'t know'" @mouseleave="buttonLabel='Build my budget'"
          >
            {{ buttonLabel }}
          </md-button>
          <md-button class="md-rose next-btn custom-btn"
                     :class="[{'disabled': !eventData.budgetPerPerson || !eventData.totalBudget}]"
                     @click="goToNext"
          >
            Next
          </md-button>
    ...
    <go-back navigation="about-invited" />
  </div>
</template>
