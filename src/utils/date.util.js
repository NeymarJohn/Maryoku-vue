...
const getTimeZoneNameFromPlaceId = async (placeId) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      var apicall = `https://maps.googleapis.com/maps/api/timezone/json?location=${placeInfo.geometry.location.lat()},${placeInfo.geometry.location.lng()}&timestamp=${new Date().getTime() / 1000}&key=AIzaSyC4qrUfpIKpm5yZ1p7wGJAxa77PJwlgKD8`
