<template>
  ...
  >
    ...
    <template slot="body">
      <div>
        <div v-if="!showSignupModal" class="md-layout">
          <div class="md-layout-item md-size-65">
            <div class="w-max-450 mx-auto py-100">
              <h2 class="font-size-30 font-bold-extra my-40">
                Continue as a Guest
              </h2>
              <MaryokuInput
                v-model="name"
                input-style="username py-20"
              ...
              <md-button class="md-red md-maryoku px-40 mt-20" @click="handle">
                Continue
              </md-button>
            </div>
          </div>
          <div class="md-layout-item md-size-35 bg-light-pink">
            <div class="d-flex flex-column align-center py-100">
              ...
              <p class="font-size-16">
                Create a new account, free of charge, to enjoy special offers & discounts!
              </p>
            </div>
          </div>
        </div>
