<template>
  <ActionModal class="negotiation-modal" container-class="modal-container md" @close="close">
    <template slot="header">
      <div class="font-bold-extra title">
        Negotiate rate
      </div>
    </template>
    <template slot="body">
    ...
    <template slot="footer">
      <md-button class="md-black md-simple my-10" @click="close">
        Cancel
      </md-button>
      <md-button class="md-red md-bold reminder-button my-10" :disabled="!value" @click="setRemind">
        Update Vendor
      </md-button>
    </template>
  </ActionModal>
