  ...
  <modal>
    ...
    <template slot="body">
      <div>
        ...
        <div>
          <md-button class="md-simple maryoku-btn" :class="{ 'md-red':!showZoomLink, 'md-black':showZoomLink }" @click="showZoomLink=!showZoomLink">
        ...
        <div>
          <md-button class="md-simple maryoku-btn" :class="{'md-red':!showCalendar, 'md-black':showCalendar }" @click="showCalendar=!showCalendar">
            Sync Your Calendar 
          ...
          <div v-if="showCalendar">
            ...
            <div class="mt-30">
              <md-radio v-model="emailAccount" class="mr-60" value="gmail"><img :src="`${$iconURL}RSVP/Image+200.png`" style="margin-top:-10px"></md-radio>
              <md-radio v-model="emailAccount" value="outlook"><img :src="`${$iconURL}RSVP/Image+201.png`" style="margin-top:-15px"></md-radio>
            </div>
