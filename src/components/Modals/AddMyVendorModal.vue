      ...
      <div class="md-layout maryoku-modal-body">
        ...
        <div class="md-layout-item md-size-100  form-group maryoku-field">
          ...
          <label class="upload-section" v-if="!editingVendor.attachment"> 
            <label class="md-rose md-outline md-simple md-sm attachment upload-button"  for="file" style="cursor:pointer">
          ...
          <div v-else class="attchment-item">
            ...
            <button @click="editingVendor.attachment=null"><md-icon class="color-white">close</md-icon></button>
          </div>
        </div>
      </div>
    </template>
