      ...
      <div v-if="step == 2" class="md-layout">
        ...
        <div class="md-layout-item md-size-100">
          <md-radio v-model="selectedOption" class="md-layout-item md-size-100" value="findAnother">
            <span calss="option-label" /> Find me alternative vendor
          </md-radio>
          <md-radio v-model="selectedOption" class="md-layout-item md-size-100" value="haveAlready">
            <span calss="option-label" /> I already have a vendor for this category
          </md-radio>
        </div>
      </div>
    </template>
    <template slot="footer">
      <md-button class="md-simple md-red md-red md-outlined" @click="cancel">
        No, take me back
      </md-button>&ensp;&ensp;
      <md-button class="md-red" @click="selectOption">
        Yes I'm sure
      </md-button>
    </template>
  </modal>
