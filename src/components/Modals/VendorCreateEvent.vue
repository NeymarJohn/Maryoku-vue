<template>
  <modal class="vendor-create-event">
    ...
    <template slot="body">
      <div>
        ...
        <div class="md-layout mt-30">
            ...
            <div class="md-layout-item md-size-50 p-0 text-left">
                <md-checkbox class="md-simple md-checkbox-circle md-vendor" v-model="selectedOption" value="unregister_customer">
          ...
          <div class="form-group text-left mt-30">
              ...
              <label class="upload-section mt-5" for="file">
                  <md-button class="md-outlined md-simple md-vendor md-sm">
                      <img class="mr-5" src="https://static-maryoku.s3.amazonaws.com/storage/icons/common/pin-dark.svg" width="15">
    ...
    <template slot="footer">
      ...
      <md-button class="md-vendor add-category-btn md-bold"
        >Done</md-button
      >
    </template>
  </modal>
...
.event-time{
    ...
    .am-field {
        ...
        &:before {
            position: absolute;
            content: ">";
            transform: translateX(50%) translateY(calc(100% + 1.2rem)) rotate(
                    90deg
            );
            left: 40%;
            font-size: 20px;
