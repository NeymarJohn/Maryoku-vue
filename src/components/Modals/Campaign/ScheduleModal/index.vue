<template>
  <modal class="campaign-schedule-modal">
        ...
        <div class="md-layout justify-content-center width-100">
          ...
          >
            <div class="d-flex align-center">
              <md-checkbox v-model="selectedOption" class="md-checkbox-circle" value="tomorrow" />
        ...
        >
          <div class="d-flex align-center">
            <md-button class="md-simple md-dark edit-btn" @click="showCalendar = true">
              ...
              <md-icon style="color: #050505 !important">
                keyboard_arrow_right
              </md-icon>
            </md-button>
          </div>
          <div v-if="scheduleSettings.calendar.calcTime > 0" :class="{ 'font-bold': selectedOption == 'calendar' }">
            {{ $dateUtil.formatScheduleDay(scheduleSettings.calendar.calcTime, "MMMM DD, YYYY hh:mm A") }}
          </div>
        </div>
      </div>
      <div v-else class="text-left">
        <div class="font-size-30 font-bold-extra p-15">
          Pick Date & Time
        </div>
        <div class="font-size-16 color-dark-gray p-15">
    ...
    <template slot="footer">
      ...
      <md-button class="md-red add-category-btn mr-15" :disabled="!canSave" @click="saveSchedule">
        Save
      </md-button>
    </template>
  </modal>
