<template>
  <div class="vtimeselector">
    ...
    <div class="vtimeselector__box_1" :class="{'vtimeselector__box_1--is-closed': pickerState.isClosed_1}">
      <ul v-if="displayHours" class="vtimeselector__box__list vtimeselector__box__list--hours">
        <!-- <li class="vtimeselector__box__head"><slot name="hours">HH</slot></li> -->
        <li v-for="(hour, index) in timeCount(interval.h, hoursLength)"
            :key="index" class="vtimeselector__box__item vtimeselector__box__item--hours"
      ...
      <ul v-if="displayMinutes" class="vtimeselector__box__list vtimeselector__box__list--minutes">
        <!-- <li class="vtimeselector__box__head"><slot name="minutes">mm</slot></li> -->
        <li v-for="(minute, index) in timeCount(interval.m)"
            :key="index" class="vtimeselector__box__item vtimeselector__box__item--minutes"
      ...
      <ul v-if="displaySeconds" class="vtimeselector__box__list vtimeselector__box__list--seconds">
        ...
        <li v-for="(second, index) in timeCount(interval.s)"
            :key="index" class="vtimeselector__box__item vtimeselector__box__item--seconds"
    ...
    <div class="vtimeselector__box_2" :class="{'vtimeselector__box_2--is-closed': pickerState.isClosed_2}">
      <ul v-if="!h24" class="vtimeselector__box__list vtimeselector__box__list--ampm">
