<template>
  <md-card class="md-card-tabs"
    ...
    <md-card-content>
      <md-list class="nav-tabs md-card" style="background-color: white !important; margin-top: -15px; width: 110%; margin-left: -55px; padding-left: 55px; margin-bottom:0; justify-content: flex-start;">
        <md-list-item
