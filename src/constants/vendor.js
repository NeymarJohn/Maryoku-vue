...
export const categoryDescriptions = {
  venuerental: {
    about_company: [
        'Give your business event a completely unique ambience at the Serafino Spa, where relaxation and tranquility combine to create the perfect, discreet environment for any occasion. Surrounded by acres of green countryside, we offer the ideal setting that lets you and your team, partners, or customers “get away from it all” while still being just a 25-minute drive from a major city. It’s a great way to refresh, reset, and refocus on a new strategy, product launch, or company vision. No distractions, no hassle. Just complete privacy and excellent service in enchanting natural surroundings',
        'Welcome to Hospitality Hotel, the most advanced modern venue for business events of all types and scales. Since 2005, we have been proud to host dozens of major events covering every aspect of the business world, from board meetings and training sessions to product launches and international conferences. Conveniently located at the heart of a bustling urban center, close to a train station and airport, we are here to serve as your global meeting point for staff, customers, partners, and all other parties. Hospitality Hotel is part of the worldwide Hospitality Corporation and pledges to bring you the very best value and service at all times.',
        'Rachel Ranch has been hosting weddings, teambuilding retreats, and events of all kinds since 1995. Founded by lifelong friends Rachel Smith and Rachel Jones, Rachel Ranch offers a truly memorable experience for all your family and business occasions, conveniently close to a major city. Our 10,000 sqm venue lets you choose between three separate areas – our grand hall, standard hall, and banquet garden – or combine them, presenting a single magnificent experience for all your guests. No matter what kind of event you’re hosting, it will benefit from the dedicated service of our on-site staff, including personal attention from the founders themselves. And of course you’ll enjoy the incredible pastoral views that bring natural tranquility into even the most high-spirited event',
    ],
    about_service: [
        'Whether you’re seeking modern business facilities, timeless leisure options, or a combination of the two, we’re here to make your stay at Serafino Spa both memorable and productive. We offer flexible meeting and event options to suit your schedule and budget, with various room and hall sizes available. Our staff will be on hand to supply standard meeting items, like notepads, coffee service, and Wi-Fi access, with many optional extras including smart TVs, projectors, and more. For a full complementary experience, give your attendees unrestricted access to our famous spa, fitness room, and extensive gardens',
  ...
  administration: {
    about_company: [
        ...
        'Outstanding service is the primary value at [company name], where we pride ourselves on offering the very best guest services and staffing solutions to corporate event planners, as well as to the actual event attendees. Our professional team is on call to provide you with the complete solution you need for any and all aspects of your event. We have served a wide range of business events, including product launches, dinners, board meetings, and conventions, with extensive capabilities that ensure smooth sailing from start to finish',
    ],
    about_service: [
        'Everything we do at [company name] is designed to ensure that each event is a positive experience for every attendee. That can include pre-event services, such as travel and hotel booking, as well as on-site event staffing, when our courteous professional team will serve as a natural extension of your existing staff. All [company name] team members are fully trained and able to assist with accessibility matters, as well as safe crowd management, in addition to helping guests with specific issues, and even finding “lost” guests if needed. Above all, we are here to serve your needs, becoming the last piece of the puzzle when making sure that all goals are accomplished and no stone is left unturned',
