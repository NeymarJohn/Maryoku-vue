export const NOTIFICATION = {
  BOOKED: {
    ...
    description:
      "Your payment has been received and will be held in escrow until the event is completed successfully. Assuming there are no disputes, we will pay the vendor 7 days after the event.",
    content: {
